    ...
    <>
      <div className="flex w-full flex-col justify-center lg:flex-row">
        <div className="lg:w-4/7 min-h-screen w-full ">
          <div className="flex h-hero w-full flex-col items-center justify-center px-5">
            <h1 className="flex flex-wrap gap-2 text-4xl font-bold leading-snug tracking-tight text-gray-800 dark:text-white lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight">
              Welcome to <p className="text-blue-9">Studlancer</p>
            </h1>
            <p className="text-md py-5 leading-normal text-slate-600 dark:text-gray-300  xl:text-xl">
              A place where you can belong to an art, business, programming,
              science, and gaming communities. Where you can spend time together
              with new friends and solve real world problems in a gamified
              fashion. A place where learning meets practical application,
              preparing you for the future, one quest at a time...
            </p>
